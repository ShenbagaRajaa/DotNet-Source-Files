...
{
    public void Insert(int EmployeeId,string EmployeeName,DateTime DateofBirth,int EmployeeAge,DateTime DateofJoin,int EmployeeExperience,double EmployeeSalary);
    public void Update();
    public void SelectAll();
    public void Delete();
    public void Selectbyid();
}
public class Employee : crud, IEmployee
{
    int EmpId;
    string? EmpName;
    DateTime DOB;
    ...
    b:
        ...
        Insert(EmployeeId, EmployeeName, DateofBirth, EmployeeAge, DateofJoin, EmployeeExperience, EmployeeSalary);
        sucobj(EmployeeName);
    }
    public void ShowEmployeeDetials()
    {
...
{
    static string connectionstr = "server=3.7.198.191;port=8993;user=bu-trausr;password=r9*rwr$!usFw0MCPj#fJ;database=bu-training;";
    ...
    public void Insert(int EmployeeId,string EmployeeName,DateTime DateofBirth,int EmployeeAge,DateTime DateofJoin,int EmployeeExperience,double EmployeeSalary)
    {
        ...
        string spinsert = "EmployeeShenbaInsert";
        cmd.CommandText = spinsert;
        cmd.Parameters.AddWithValue("@EmpNo", EmployeeId);
        cmd.Parameters.AddWithValue("@EmpName", EmployeeName);
        cmd.Parameters.AddWithValue("@EmpDoB", DateofBirth);
        cmd.Parameters.AddWithValue("@EmpAge", EmployeeAge);
        cmd.Parameters.AddWithValue("@EmpDoJ", DateofJoin);
        cmd.Parameters.AddWithValue("@EmpExp", EmployeeExperience);
